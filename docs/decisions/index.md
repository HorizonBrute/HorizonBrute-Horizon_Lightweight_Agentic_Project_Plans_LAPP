...
| ADR | Title | Status |
|---|---|---|
| [0001](ADR-0001-dual-mode-package.md) | Dual-mode package: standalone core + optional Horizon.AIOS wrapper | Accepted |
...
| [0005](ADR-0005-sync-gate-on-registry.md) | Gate the Horizon.AIOS official sync lane on the registry | Accepted |
